...
namespace  {
             ...
             * @return \Illuminate\Database\Eloquent\Builder|static 
             * @static 
             */            public static function whereLike($field, $searchTerm)
            {
                                return \Illuminate\Database\Eloquent\Builder::whereLike($field, $searchTerm);
            }
                            /**
             * 
             *
             ...
             * @return \Illuminate\Database\Eloquent\Builder|static 
             * @static 
             */            public static function whereAnyLike($fields, $searchTerm)
            {
                                return \Illuminate\Database\Eloquent\Builder::whereAnyLike($fields, $searchTerm);
            }
                            /**
             * 
             *
             ...
             * @return \Illuminate\Database\Eloquent\Builder|static 
             * @static 
             */            public static function orderByDynamic($sort_field, $sort_value)
            {
                                return \Illuminate\Database\Eloquent\Builder::orderByDynamic($sort_field, $sort_value);
            }
                            /**
